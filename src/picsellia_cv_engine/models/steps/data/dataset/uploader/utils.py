...
from picsellia_cv_engine.models.steps.data.dataset.uploader.classification.coco_classification_dataset_uploader import (
    ClassificationDatasetUploader,
)
from picsellia_cv_engine.models.steps.data.dataset.uploader.common.data_uploader import (
    DataUploader,
)
from picsellia_cv_engine.models.steps.data.dataset.uploader.object_detection.object_detection_dataset_uploader import (
    ObjectDetectionDatasetUploader,
)
from picsellia_cv_engine.models.steps.data.dataset.uploader.segmentation.segmentation_dataset_uploader import (
...
def upload_images(dataset: CocoDataset, datalake: Datalake, data_tag: str):
    ...
    uploader = DataUploader(dataset_version=dataset.dataset_version)
    image_paths = [
