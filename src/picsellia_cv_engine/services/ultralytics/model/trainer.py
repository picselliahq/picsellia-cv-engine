...
from picsellia_cv_engine.services.ultralytics.model.logger.classification import (
    UltralyticsClassificationLogger,
    UltralyticsClassificationMetricMapping,
)
from picsellia_cv_engine.services.ultralytics.model.logger.object_detection import (
    UltralyticsObjectDetectionLogger,
    UltralyticsObjectDetectionMetricMapping,
)
from picsellia_cv_engine.services.ultralytics.model.logger.segmentation import (
