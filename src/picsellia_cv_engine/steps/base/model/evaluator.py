...
def evaluate_model(
    ...
    Args:
        picsellia_predictions (Union[List[PicselliaClassificationPrediction],
                                      List[PicselliaRectanglePrediction],
                                      List[PicselliaPolygonPrediction],
                                      List[PicselliaOCRPrediction]]):
            A list of predictions generated by the model. Each item corresponds to a supported prediction type.
