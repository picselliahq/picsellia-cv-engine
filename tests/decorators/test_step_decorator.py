...
class TestStepDecorator:
    def test_step_decorator_returns_configured_step_object(
        ...
        assert isinstance(decorated_function, Step), (
            "The decorated function should be an instance of Step."
        )

        assert decorated_function.step_name == mock_step_entrypoint_pass.__name__, (
    ...
    def test_step_decorator_get_state(
        ...
        assert decorated_function_1.state == decorated_function_1.metadata.state, (
    ...
    def test_step_get_logger(self, mock_pipeline, step_factory):
        ...
        assert step_logger == mock_pipeline.logger_manager.logger, (
